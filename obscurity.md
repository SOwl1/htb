...
![](https://SOwl1.github.io/htb/images/obscurity/nmap1.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/nmap2.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/webpage.png)

Scrolling down, there's a note to the devs that the current source is located in a development directory.

![](https://SOwl1.github.io/htb/images/obscurity/devNote.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/wfuzz.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/serverCode.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/initialShell.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/robertDir.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/parser.png)

We're also given ```check.txt``` file and the output of the encryption in the form of ```out.txt```. 

![](https://SOwl1.github.io/htb/images/obscurity/checkOut.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/keyCrack.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/password.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/user.png)

```sudo -l``` shows that we can run the ```/home/robert/BetterSSH/BetterSSH.py``` file as root.

![](https://SOwl1.github.io/htb/images/obscurity/sudoL.png)
...
![](https://SOwl1.github.io/htb/images/obscurity/dumped.png)

From there, it was as easy as running the hash through ```john``` and logging in.

![](https://SOwl1.github.io/htb/images/obscurity/crackedRoot.png)

![](https://SOwl1.github.io/htb/images/obscurity/root.png)
